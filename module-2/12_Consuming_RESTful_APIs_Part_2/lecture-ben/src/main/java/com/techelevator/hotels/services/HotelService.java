...
public class HotelService {
    ...
    public boolean deleteReservation(int id) {
        ...
        // Alternate way to check for success is to check to see if resource is gone
        Reservation returnedReservation = getReservation(id);
        return returnedReservation == null;
    }
