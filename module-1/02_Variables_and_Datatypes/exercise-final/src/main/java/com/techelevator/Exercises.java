...
public class Exercises {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        int dimeCount = 1;
        int nickelCount = 2;
        double totalCents = (quarterCount * 0.25) + (dimeCount * .10) + (nickelCount * .05);
        ...
        */
        ...
        int timeSpentInMinutesMorning = (1 * MINUTES_PER_HOUR) + 30;
        ...
        */
        double costPerPencil = .07;
        double startingAmount = 0.50;
        ...
        */
        ...
        int hoursToSeeGrandma = daysToSeeGrandma * HOURS_PER_DAY;
