...
namespace WordSearch.Tests
{
    ...
    public class WordSearchTests
    {
        ...
        private const string WordToSearchCaseSensitive = "between";
        private const string WordToSearchCaseInsensitive = "beTween";
        ...
        {
            string input = testTextFile + Environment.NewLine + WordToSearchCaseInsensitive + Environment.NewLine + "n";
        ...
        {
            string input = testTextFile + Environment.NewLine + WordToSearchCaseSensitive + Environment.NewLine + "y";
            StringBuilder output = new StringBuilder();
