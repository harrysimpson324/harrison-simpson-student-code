...
public class App {
    ...
    private final HotelService hotelService = new HotelService(); // REST API calls
    private final AuthenticationService authenticationService = new AuthenticationService(); // Authentication calls
