...
DROP TABLE IF EXISTS movie_genre, movie_actor, movie, collection, person, genre;
CREATE TABLE [genre] (
...
SET IDENTITY_INSERT person ON;
INSERT INTO person (person_id, person_name, birthday, deathday, biography, profile_path, home_page) VALUES (2636, 'Alfred Hitchcock', '8/13/1899', CAST(N'4/29/1980' AS Date), NULL, 'https://image.tmdb.org/t/p/w185/108fiNM6poRieMg7RIqLJRxdAwG.jpg', NULL);
SET IDENTITY_INSERT person OFF;
...
INSERT INTO movie (movie_id, title, overview, tagline, poster_path, home_page, release_date, length_minutes, director_id, collection_id) VALUES (521, 'Dial M for Murder', 'An ex-tennis pro carries out a plot to have his wife murdered after discovering she is having an affair, and assumes she will soon leave him for the other man anyway. When things go wrong, he improvises a new plan—to frame her for murder instead.', 'If a woman answers... hang on for dear life!', 'https://image.tmdb.org/t/p/w500/4qPIsFXLVH9feiRBpCf2XRZqK4k.jpg', NULL, '5/29/1954 12:00:00 AM', 105, '2636', NULL);
...
INSERT INTO movie (movie_id, title, overview, tagline, poster_path, home_page, release_date, length_minutes, director_id, collection_id) VALUES (381, 'To Catch a Thief', 'An ex-thief is accused of enacting a new crime spree, so to clear his name he sets off to catch the new thief, who’s imitating his signature style.', 'WANTED by the police in all the luxury-spots of Europe!... A catch for any woman!', 'https://image.tmdb.org/t/p/w500/wizxvCHhWTpJXxRew6FGPGFWTVl.jpg', NULL, '8/3/1955 12:00:00 AM', 107, '2636', NULL);
...
INSERT INTO movie (movie_id, title, overview, tagline, poster_path, home_page, release_date, length_minutes, director_id, collection_id) VALUES (539, 'Psycho', 'When larcenous real estate clerk Marion Crane goes on the lam with a wad of cash and hopes of starting a new life, she ends up at the notorious Bates Motel, where manager Norman Bates cares for his housebound mother.', 'A new—and altogether different—screen excitement!', 'https://image.tmdb.org/t/p/w500/nR4LD4ZJg2n6LZQpcOrLFdMq0cD.jpg', NULL, '6/22/1960 12:00:00 AM', 109, '2636', '119674');
-- cmc
