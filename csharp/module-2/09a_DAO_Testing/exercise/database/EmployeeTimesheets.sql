...
-- Delete the EmployeeTimesheets database if it exists
IF DB_ID('EmployeeTimesheets') IS NOT NULL
BEGIN
	ALTER DATABASE EmployeeTimesheets SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
	DROP DATABASE EmployeeTimesheets;
END

-- Create a new EmployeeTimesheets database
CREATE DATABASE EmployeeTimesheets;
GO

-- Switch to the EmployeeTimesheets database
USE EmployeeTimesheets;
GO

BEGIN TRANSACTION;

DROP TABLE IF EXISTS project_employee, employee, project, department, timesheet;
...
INSERT INTO department (department_id, name) VALUES (1, 'Department of Redundancy Department');
INSERT INTO department (department_id, name) VALUES (2, 'Network Administration');
INSERT INTO department (department_id, name) VALUES (3, 'Research and Development');
INSERT INTO department (department_id, name) VALUES (4, 'Store Support');
