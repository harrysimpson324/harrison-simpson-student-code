...
namespace Exercises.Tests.Classes
{
    ...
    public class EmployeeTests
    {
        ...
        public void Setup()
        {
            Type type = Type.GetType(typeof(Employee).AssemblyQualifiedName);
            Assert.IsFalse(type.IsAbstract, "Employee class must not be abstract. Remove the 'abstract' modifier on Employee.");
        }
