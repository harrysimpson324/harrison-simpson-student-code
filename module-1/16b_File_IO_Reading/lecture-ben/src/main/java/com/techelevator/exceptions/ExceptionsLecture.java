...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("YYY   Uh-oh, something went wrong...   XXX");
		}
			...
			// Flow of control resumes here after the Exception is thrown
			System.out.println(e.getMessage());
			System.out.println("ZZZ   Uh-oh, something went wrong...   XXX");
		}

		System.out.println("Finished with cities in Ohio example");
		System.out.println();
