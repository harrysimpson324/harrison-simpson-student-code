...
public class LectureTest {
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		Assert.assertEquals("The correct length of four should be shown for 'Java'", 4, length); // Assert
	}

//	@Test
//	public void turnOn_should_set_isOn_to_true() {
//		//ARRANGE
//		Television tv = new Television();
//
//		//ACT
//		boolean actual = tv.turnOn();
...
//	}
	...
	@Test
	public void nine_divided_by_three_equals_three() {
		//Arrange
		double initialValue = 9.99;
		double divisor = 3.33;

		// Act
		double actual = initialValue / divisor;

		// Assert
		Assert.assertEquals(3.1, actual, 0.01);
