...
DROP TABLE IF EXISTS transfer, account, movie_user, transfer_type, transfer_status;
...
CREATE TABLE movie_user (
	...
	role varchar(20),
	CONSTRAINT PK_movie_user PRIMARY KEY (user_id),
...
CREATE TABLE account (
	...
	CONSTRAINT FK_account_movie_user FOREIGN KEY (user_id) REFERENCES movie_user (user_id)
);
...
INSERT INTO movie_user (username,password_hash,role) VALUES ('user1','user1','ROLE_USER'); -- 1001
INSERT INTO movie_user (username,password_hash,role) VALUES ('user2','user2','ROLE_USER'); -- 1002
INSERT INTO movie_user (username,password_hash,role) VALUES ('user3','user3','ROLE_USER');
