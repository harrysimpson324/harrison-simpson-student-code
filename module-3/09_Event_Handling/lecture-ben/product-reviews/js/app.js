...
function saveReview() {
  ...
  if (name.value && title.value) {
    ...
    if (!name.value) {
      name.previousElementSibling.innerText = "Name (required!)";
      name.previousElementSibling.style.color = 'red';
    }
    else {
      name.previousElementSibling.innerText = "Name";
      name.previousElementSibling.style.color = 'black';
    }
    if (!title.value) {
      title.previousElementSibling.innerText = "Title (required!)";
      title.previousElementSibling.style.color = 'red';
    }
    else {
      title.previousElementSibling.innerText = "Title";
      title.previousElementSibling.style.color = 'black';
    }
  }
}
